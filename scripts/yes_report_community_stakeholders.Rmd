...
**When we run statistical tests (paired t-tests), youth report...**

+ significant improvements in all three outcomes from before to after the ABC Project:
...
+ significant improvements in all three outcomes from before to after the Project CARE:
...
+ significant improvements in all three outcomes from before to after the Project Personality:
