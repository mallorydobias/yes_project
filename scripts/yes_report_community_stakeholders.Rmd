...
```{r, out.width = "700px", out.height = "240px", include=TRUE, echo=FALSE}
...
+ **`r perc_pp_lot_little_less_hopeless`-`r perc_abc_lot_little_less_hopeless`% were "a lot" or "a little" less hopeless**
+ **`r perc_pp_lot_little_more_prob`-`r perc_abc_lot_little_more_prob`% were "a lot" or "a little" more able to solve problems**
