...
**We develop digital, evidence-based youth mental health supports that make an impact at scale.** Each "Single-Session Intervention", or SSI, is designed as a standalone experience; in ~20-minutes, youth walk away with a concrete lesson, skill, or plan to make a difference for their mental health. We [published Project YES](https://www.schleiderlab.org/yes.html), an online platform to share our SSIs publicly.
...
**We maximize the impact 20 minutes can make.** By focusing on core principles of evidence-based mental health intervention and psychotherapies (e.g., "you are capable of change", "your thoughts and feelings are connected"), we make the most of limited time. 
...
Note: We collected these data using slightly different age categories over time; this explains the overlap in some age groups above. 
...
**`r perc_youth_no_support`% of youth responses had never accessed formal mental health support.** 
