...
Within d07, we have SSI completion rate data before and after introducing commitment items (where teens "commit" to finishing the SSI they chose). Here, we plot SSI completions by date, indicating when the commit items were introduced.
...
More than 20 people completed an SSI 
