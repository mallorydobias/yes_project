...
Calculating depressive symptoms (only measured pre-SSI). Scores can range from 0 to 26, where 0 = not true, 1 = sometimes, 2 = true. Scores of 12 or higher suggest depression. Source: https://doi.org/10.1002/mpr.1610
...
data_mfq_scored <- data_rise_named %>%
...
identical(test_mfq_pre$count, test_mfq_post$count) # true if responses match from pre to post mutation
