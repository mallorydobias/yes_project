...
Calculating agency using the 3-item pathways subscale from the State Hope Scale (measured pre and post SSI). Row mean scores range from 0 to 8, where 1 = definitely false, and 8 = definitely true. Source: https://doi.org/10.1037/0022-3514.70.2.321
...
```{r shs numeric class validation, validate=TRUE}

data_shs_mutated %>%
  pointblank::col_is_numeric(vars(pre_shs_1)) # passes if vars are now numeric
...
Checking pre and post shs totals are identical across sum methods
