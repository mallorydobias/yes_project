...
data_gender_trans_masc_cleaned <- data_gender_ftm_cleaned %>%
...
data_gender_intersex_cleaned <- data_gender_genderqueer_cleaned %>%
...
file_name <- "yes_data_nu_english_clean.csv"
