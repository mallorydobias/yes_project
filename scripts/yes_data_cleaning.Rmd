...
data_gender_boys_cleaned <- data_race_cleaned %>%
  ...
  mutate(dem_gender_boy_man = case_when(
    str_detect(dem_gender_identity, "^Male$") | str_detect(dem_gender_identity, "Male,") ~ "yes",
    !str_detect(dem_gender_identity, "^Male$") & !str_detect(dem_gender_identity, "Male,") 
...
data_gender_girls_cleaned <- data_gender_boys_cleaned %>%
  mutate(dem_gender_girl_woman = case_when(
    str_detect(dem_gender_identity, "^Female$") | str_detect(dem_gender_identity, "Female,") ~ "yes",
    !str_detect(dem_gender_identity, "^Female$") & !str_detect(dem_gender_identity, "Female,") 
      & !is.na(dem_gender_identity) ~ "no",
    TRUE ~ NA_character_)) 

# checking this worked

# data_gender_girls_cleaned %>%
#   filter(str_detect(dem_gender_identity, "Female")) %>%
#   select(dem_gender_identity, dem_gender_girl_woman) # looks good
...
# data_gender_trans_cleaned %>%
#   filter(str_detect(dem_gender_identity, "Transgender")) %>%
#   select(dem_gender_identity, dem_gender_trans) # looks good
...
data_mfq_mutated <- data_race_cleaned %>%
