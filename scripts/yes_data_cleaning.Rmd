...
Calculating depressive symptoms (only measured pre-SSI). Scores range from 0 to 26, where 0 = not true, 1 = sometimes, 2 = true. Scores of 12 or higher suggest depression. Source: https://doi.org/10.1002/mpr.1610
...
identical(test_mfq_calc$mfq_total, test_mfq_calc$manual_mfq_total) # true if mfq totals are consistent across sum method
