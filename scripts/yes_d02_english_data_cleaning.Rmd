...
raw_data <- read.csv(here("data", "raw", "Project YES - ENGLISH AND SPANISH_January 3, 2025_09.47.csv")) # directing to data from project folder root
...
NOTE 2: While this measure can be seen in the survey flow, it looks like no self-hate data have been collected for this survey. (Possibly a "publish" button error.)
...
data_classes_mutated <- data_reorged %>%
  ...
  mutate(across(matches("^san_antonio_.*") & !matches("text"), as.factor)) %>%
