...
gender_tallies <- count_yes_responses(data_youth_gender) %>%
  ...
  mutate(gender_identity = str_replace(gender_identity, "girl_woman", "Girl/Woman"),
         ...
         gender_identity = str_replace(gender_identity, "ftm_trans", "Female to male transgender/FTM"),
         ...
         gender_identity = str_replace(gender_identity, "trans_masc", "Trans male/Trans masculine"),
         ...
         gender_identity = str_replace(gender_identity, "mtf_trans", "Male to female transgender/MTF"),
         gender_identity = str_replace(gender_identity, "trans_fem", "Trans female/Trans feminine")) %>%
  arrange(-n)
