...
plot_abc_drop <- ggplot(data_abc_clicks_plot, aes(x=page, y=page_submissions)) +
  ...
  geom_vline(xintercept = 43, color = "darkgrey") +
...
plot_pp_drop <- ggplot(data_pp_clicks_plot, aes(x=page, y=page_submissions)) +
  ...
  labs(x = "page number",
       y = "n page submissions") +
  geom_vline(xintercept = 16, color = "darkgrey") + 
  geom_vline(xintercept = 30, color = "darkgrey") +
  geom_vline(xintercept = 31, color = "darkgrey")
