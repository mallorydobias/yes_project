...
Here, we pull the number of starts, completions, and completion rate overall and within each SSI.
...
Here, we plot completion rates for each SSI.
...
plot_completions_by_date <- ggplot(plot_data_completions_per_date, aes(x = start_date, y = n)) +   
  ...
  theme_minimal() +
  labs(x = "", y = "n ssis completed", title = "Daily SSI Completions by Start Date (d02 only)") +
  theme(legend.position = "none") +
