...
```{r exporting race table to word, include=FALSE}

# Create a flextable directly from race_tallies
flextable_output <- flextable::flextable(race_tallies)

# Add additional formatting if needed (e.g., autofit for columns)
flextable_output <- flextable::autofit(flextable_output)

# Create a Word document
doc <- officer::read_docx()

# Add the flextable to the document
doc <- flextable::body_add_flextable(doc, value = flextable_output)
...
print(doc, target = file.path(tables_folder, "race_tallies_table.docx"))
