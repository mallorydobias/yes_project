...
**`r perc_gender_differs_from_sex`% of responses endorsed a gender identity different from assigned sex.** 

Gender(s), of all survey starts from youth (n = `r n_started_survey`): 
...
**`r perc_sex_minority`% of responses endorsed a sexual orientation other than heterosexual.** 

Sexual orientation(s), of all survey starts from youth (n = `r n_started_survey`): 
