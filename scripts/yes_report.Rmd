...
```{r plotting overall pfs mean scores by ssi, include=FALSE, echo=TRUE, warning=FALSE}
...
```{r plotting abc pfs items scores, include=FALSE, warning=FALSE}
...
```{r plotting care pfs items scores, include=FALSE, warning=FALSE}
...
```{r plotting pp pfs items scores, include=FALSE, warning=FALSE}
...
```{r plotting rise pfs items scores, include=FALSE, warning=FALSE}
...
```{r printing ridge plot for all pfs, warning=FALSE, include=TRUE}
