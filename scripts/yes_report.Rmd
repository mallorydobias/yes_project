...
Combining all abc pre-post outcomes into one plot. Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
plots_abc <- plot_abc_bhs + plot_abc_shs + plot_abc_hate +
  plot_annotation(title = "Outcomes before vs after ABC Project",
                  ...
                  caption = "Left = hopelessness scores (BHS) before and after ABC;
                  Middle = agency scores (SHS) before and after ABC;
                  Right = self-hate scores before and after ABC.")
...
Combining all project care pre-post outcomes into one plot. Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
plots_care <- plot_care_bhs + plot_care_shs + plot_care_hate +
  plot_annotation(title = "Outcomes before vs after Project CARE",
                  theme = theme(plot.title = element_text(hjust = 0.5)),
                  caption = "Left = hopelessness scores (BHS) before and after CARE;
                  Middle = agency scores (SHS) before and after CARE;
                  Right = self-hate scores before and after CARE.")
...
plots_pp <- plot_pp_bhs + plot_pp_shs + plot_pp_hate +
   plot_annotation(title = "Outcomes before vs after Project Personality",
                  theme = theme(plot.title = element_text(hjust = 0.5)),
                  caption = "Left = hopelessness scores (BHS) before and after Personality;
                  Middle = agency scores (SHS) before and after Personality;
                  Right = self-hate scores before and after Personality.")
...
```{r printing pp change hopelessness, include=TRUE}
...
```{r printing pp change problem solving, include=TRUE}
...
Of those who answered this question, **`r perc_rise_lot_little_less_hopeless`% of responses reported they felt "a lot" or "a little" less hopeless post-RISE.**

```{r printing rise change hopelessness, include=TRUE}
...
Of those who answered this question, **`r perc_rise_lot_little_more_prob`% of responses reported they felt "a lot" or "a little" more able to solve problems post-RISE.**

```{r printing rise change problem solving, include=TRUE}
