...
```{r creating separate boxplots pfs item, include=FALSE, warning=FALSE}
...
```{r creating combined pfs item boxplot, echo=TRUE, warning=FALSE, message=FALSE, fig.width=8, fig.height=10}
