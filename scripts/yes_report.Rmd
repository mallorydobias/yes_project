...
When asked, **youth agreed to questionnaires > half of the time (`r perc_agreed_questionnaires`%, n = `r n_agreed_questionnaires`)**.
...
**`r perc_sex_minority`% of responses endorsed a non-heterosexual orientation.** Sexual orientation(s), of all survey starts from youth (n = `r n_started_survey`). 
...
Combining all abc pre-post outcomes into one plot. Left plot shows distributions of hopelessness scores (BHS scale) before and after abc; middle plot shows distributions of agency scores (SHS scale, pathways subscale) before and after abc; right plot shows distributions of self-hate scores before and after abc. Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
Combining all project care pre-post outcomes into one plot. Left plot shows distributions of hopelessness scores (BHS scale) before and after project care; middle plot shows distributions of agency scores (SHS scale, pathways subscale) before and after project care; right plot shows distributions of self-hate scores before and after project care. Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
Combining all project personality pre-post outcomes into one plot. Left plot shows distributions of hopelessness scores (BHS scale) before and after project personality; middle plot shows distributions of agency scores (SHS scale, pathways subscale) before and after project personality; right plot shows distributions of self-hate scores before and after project personality Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
Of those who answered this question, **`r perc_pp_lot_little_less_hopeless`% of responses reported they felt "a lot" or "a little" less hopeless post-Project Personality.**
...
Of those who answered this question, **`r perc_pp_lot_little_more_prob`% of responses reported they felt "a lot" or "a little" more able to solve problems post-Project Personality.**
