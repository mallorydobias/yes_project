...
+ Hopelessness decreased, hope increased, and self-hate decreased pre to post ABC (dzs = `r abc_dz_values`)
+ Hopelessness decreased and self-hate decreased pre to post CARE (dzs = `r care_dz_values`)
+ Hopelessness decreased, hope increased, and self-hate decreased pre to post Project Personality (dzs = `r pp_dz_values`)
...
Conducting a paired t-test to evaluate pre vs post-abc changes in hope (shs pathways scores). For those who chose the abc intervention with data at both time points, hope increased from pre to post abc, dz = `r abc_shs_dz_value`.
...
Conducting a paired t-test to evaluate pre vs post-care changes in hope (shs pathways scores). For those who chose the care intervention with data at both time points, we detect no significant change in hope from pre to post care, dz = `r care_shs_dz_value`.
...
Conducting a paired t-test to evaluate pre vs post-project personality changes in hope (shs pathways scores). For those who chose the project personality intervention with data at both time points, hope increased from pre to post project personality, dz = `r pp_shs_dz_value`.
...
Conducting a paired t-test to evaluate pre vs post-rise changes in hope (shs pathways scores). For those who chose the rise intervention with data at both time points, we find no evidence that hope increased from pre to post rise, dz = `r rise_shs_dz_value`. However, this test is currently run in a very small sample size (n = `r (t_rise_shs$df) + 1`).
