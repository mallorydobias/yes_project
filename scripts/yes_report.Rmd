...
Combining all project personality pre-post outcomes into one plot. Within each plot, higher scores (i.e., further to the right) reflect more hopelessness, agency, and self-hate respectively.
...
```{r printing completion rate data pre commit item, include=TRUE}
