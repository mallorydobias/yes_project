...
```{r plotting overall pfs mean scores by ssi, include=FALSE, echo=TRUE}
...
data_youth_abc %>%
  select(starts_with("pfs_") & -contains("like") & -contains("change"), -contains("feedback"), -contains("tim"), ssi_choice)
