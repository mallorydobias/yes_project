...
```{r calculating proportion of teens elevated depression, echo=FALSE}
...
**Across all survey starts, `r perc_youth_no_support`% report never accessing mental health support, despite wanting to.**

```{r showing unmet mental health need, include=TRUE}

perc_youth_no_support

```

**`r perc_youth_no_support_w_depression`% report never accessing mental health support AND elevated depressive symptoms (MFQ score of 12 or higher)**. 

```{r showing no access to support and depression, include=TRUE}
...
Here, we plot responses to the treatment access question. Notably, this figure does not include missing responses.
...
```{r printing care change hopelessness, include=TRUE}
...
```{r printing care change problem solving, include=TRUE}
