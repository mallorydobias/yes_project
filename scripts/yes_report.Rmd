...
# (no history of support, but they've wanted support)
...
+ `r perc_youth_no_support`% report never accessing mh support despite wanting it
+ `r perc_youth_no_support_w_depression`% report no history of mh support access AND elevated depression symptoms
...
+ **`r perc_youth_no_support`% never accessed mental health support,** despite wanting to.
...
+ **`r perc_youth_no_support_w_depression`% never accessed mental health support AND had elevated depressive symptoms** (MFQ score of 12 or higher). 
...
custom_order <- c("no (never wanted it)", "no (has wanted it)", "yes (now)", "yes (past)", "yes (now),yes (past)")
...
```{r plotting access to support, echo=FALSE}
