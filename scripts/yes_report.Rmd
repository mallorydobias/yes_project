...
+ There's lots of missing demographic data, given optional questionnaires
...
+ `r perc_sex_minority`% identify as a sexual minority
+ `r perc_racial_minority`% identify as a racial minority
