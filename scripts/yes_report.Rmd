...
+In `perc_completed_any_ssi`% of cases where someone started an ssi (n = `n_started_any_ssi`), they completed it (n = `n_completed_any_ssi`)
+In `perc_completed_abc`% of cases where someone started ABC (n = `n_started_abc`), they completed it (n = `n_completed_abc`)
+In `perc_completed_care`% of cases where someone started CARE (n = `n_started_care`), they completed it (n = `n_completed_care`)
+In `perc_completed_pp`% of cases where someone started Project Personality (n = `n_started_pp`), they completed it (n = `n_completed_pp`)
+In `perc_completed_rise`% of cases where someone started RISE (n = `n_started_rise`), they completed it (n = `n_completed_rise`)
...
Of `n_started_abc` cases where someone started abc, `n_completed_abc` cases completed the intervention. This results in an abc completion rate of `perc_completed_abc`%.
...
Of `n_started_care` cases where someone started care, `n_completed_care` cases completed the intervention. This results in an project care completion rate of `perc_completed_care`%.
...
Of `n_started_pp` cases where someone started project personality, `n_completed_pp` cases completed the intervention. This results in a project personality completion rate of `perc_completed_pp`%.
...
Of `n_started_rise` cases where someone started project rise, `n_completed_rise` cases completed the intervention. This results in a project rise completion rate of `perc_completed_rise`%.
...
Of `n_started_any_ssi` cases where someone started any ssi, `n_completed_any_ssi` cases completed the intervention. This results in an overall completion rate of `perc_completed_any_ssi`% for any ssi.
