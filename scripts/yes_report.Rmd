...
care_dz_values <- c(care_bhs_dz_value, care_shs_dz_value, care_hate_dz_value)
...
+ Hopelessness decreased, hope increased, and self-hate decreased pre to post CARE (dzs = `r care_dz_values`)
