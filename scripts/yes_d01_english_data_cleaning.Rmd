...
data_mfq_mutated <- data_prev_completed_cleaned %>%
...
test_mfq_pre <- data_prev_completed_cleaned %>%
...
test_mutate <- prep_mutation_check(data_prev_completed_cleaned, data_mfq_mutated, "mfq_1") # same output as test_mfq_mutate above
