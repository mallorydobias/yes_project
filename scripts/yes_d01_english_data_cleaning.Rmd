...
## Reading in cleaned data from yes pub

## Pulled from: https://osf.io/zguj4

old_data <- read.csv(here("data", "raw", "yes_cleaned_using_r_april_5_2020_anonymized_for_osf.csv")) # directing to data from project folder root
