...
english_data_bound <- bind_rows(d02_data, d03_data, d09_data)
...
validation_result <- 
  english_data_bound %>%
  expect_row_count_match(nrow(d02_data) + nrow(d03_data) + nrow(d09_data))
...
print(validation_result_d02$validation_result)
...
print(validation_result_d03$validation_result)
...
print(validation_result_d09$validation_result)
